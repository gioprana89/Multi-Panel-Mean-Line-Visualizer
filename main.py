...
st.set_page_config(
    page_title="STATCAL ONLINE - Multi-Panel Mean Line Visualizer",
    page_icon="📈",
    layout="wide",
)
...
APP_TITLE = "Multi-Panel Mean Line Visualizer"
APP_UPDATED = "Last updated on June 15, 2026"
...
st.sidebar.header("6. Export Settings")
dpi = st.sidebar.selectbox("PNG resolution / DPI", [300, 600, 900, 1200, 1500], index=1)
transparent_background = st.sidebar.checkbox("Transparent PNG background", value=False)


# =====================================================
# MAIN DISPLAY: DATA SUMMARY
# =====================================================
...
# =====================================================
# MAIN DISPLAY: DESCRIPTIVE STATISTICS
# =====================================================
...
# =====================================================
# MAIN DISPLAY: MEAN LINE PANEL CHART
# =====================================================

st.subheader("Publication-Ready Mean Line Panel Chart")

if len(panel_variables) < len(selected_numeric_cols):
    st.info(f"Showing the first {len(panel_variables)} numeric-variable panels. Increase 'Maximum numeric-variable panels' in the sidebar to show more.")

with st.expander("Mean line chart data preview", expanded=False):
    st.dataframe(make_arrow_safe_dataframe(chart_long_data.head(300)))
...
mean_line_png = fig_to_png_bytes(mean_line_fig, dpi=dpi, transparent_background=transparent_background)
st.download_button(
